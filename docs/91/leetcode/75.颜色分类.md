...
## 题目地址
[点击打开题目](https://leetcode-cn.com/problems/sort-colors)
...
- [荷兰国旗问题(Wiki)](https://en.wikipedia.org/wiki/Dutch_national_flag_problem)
- 排序
...
这个问题是典型的 [荷兰国旗问题(Wiki)](https://en.wikipedia.org/wiki/Dutch_national_flag_problem)。 因为我们可以将红白蓝三色小球想象成条状物，有序排列后正好组成荷兰国旗。
